    ...
    <footer className="flex w-full flex-col items-center gap-20 bg-transparent px-6 py-8 sm:px-14 md:px-20">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 rounded-2xl bg-accent p-8 text-background sm:p-12 md:gap-12 lg:p-20">
        ...
        <a
          ...
          target="_blank"
          className="mb-6 max-w-full cursor-pointer break-all text-center text-base font-bold underline sm:text-lg md:text-xl"
        >
          {siteMetadata.email}
        </a>
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 text-center  md:flex-row md:justify-between lg:mx-auto lg:max-w-7xl">
        <span className="text-foreground">© {new Date().getFullYear()} Data for Public Impact Network. Website built on a framework by Amit Chauhan.</span>
